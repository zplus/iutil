...
<div class="form-group">
    ...
    <div class="col-md-3">
        <select id="field_province" name="field_province" data-role="region" data-default="" required class="form-control">
        </select>
    </div>
    <div class="col-md-3">
        <select id="field_city" name="field_city" data-role="region" data-default="" required class="form-control">
        </select>
    </div>
    <div class="col-md-3">
        <select id="field_district" name="field_district" data-role="region" data-default="" required class="form-control">
        </select>
    </div>
</div>
**/
...
var province = ["北京", "天津", "河北", "山西", "内蒙古", "辽宁", "吉林", "黑龙江", "上海", "江苏", "浙江", "安徽", "福建", "江西", "山东", "河南", "湖北", "湖南", "广东", "广西", "海南", "重庆", "四川", "贵州", "云南", "西藏", "陕西", "甘肃", "青海", "宁夏", "新疆", "香港", "澳门", "台湾"];
var city = [
    ["北京市"],
    ["天津市"],
    ...
    ["武汉市", "黄石市", "十堰市", "宜昌市", "襄樊市", "鄂州市", "荆门市", "孝感市", "荆州市", "黄冈市", "咸宁市", "随州市", "恩施土家族苗族自治州", "省直辖县级行政单位"],
    ...
    ["乌鲁木齐市", "克拉玛依市", "吐鲁番地区", "哈密地区", "昌吉回族自治州", "博尔塔拉蒙古自治州", "巴音郭楞蒙古自治州", "阿克苏地区", "克孜勒苏柯尔克孜自治州", "喀什地区", "和田地区", "伊犁哈萨克自治州", "塔城地区", "阿勒泰地区", "省直辖县级行政单位"],
    ["香港"],
    ["澳门"],
    ["台湾"]
];
var district = [
    ...
    [
        ["和平区", "河东区", "河西区", "南开区", "河北区", "红桥区", "塘沽区", "汉沽区", "大港区", "东丽区", "西青区", "津南区", "北辰区", "武清区", "宝坻区", "宁河县", "静海县", "蓟县", "保税区", "经济技术开发区", "高新区", "滨海新区"]
    ],
    [
        ["长安区", "桥东区", "桥西区", "新华区", "井陉矿区", "裕华区", "井陉县", "正定县", "栾城县", "行唐县", "灵寿县", "高邑县", "深泽县", "赞皇县", "无极县", "平山县", "元氏县", "赵县", "辛集市", "藁城市", "晋州市", "新乐市", "鹿泉市", "高新技术开发区"],
        ["路南区", "路北区", "古冶区", "开平区", "丰南区", "丰润区", "滦县", "滦南县", "乐亭县", "迁西县", "玉田县", "唐海县", "遵化市", "迁安市", "高新区", "汉沽管理区", "海港开发区", "芦台开发区", "南堡开发区", "曹妃甸工业区"],
        ["海港区", "山海关区", "北戴河区", "青龙满族自治县", "昌黎县", "抚宁县", "卢龙县", "经济技术开发区"],
        ["邯山区", "丛台区", "复兴区", "峰峰矿区", "邯郸县", "临漳县", "成安县", "大名县", "涉县", "磁县", "肥乡县", "永年县", "邱县", "鸡泽县", "广平县", "馆陶县", "魏县", "曲周县", "武安市", "经济开发区"],
        ["桥东区", "桥西区", "邢台县", "临城县", "内丘县", "柏乡县", "隆尧县", "任县", "南和县", "宁晋县", "巨鹿县", "新河县", "广宗县", "平乡县", "威县", "清河县", "临西县", "南宫市", "沙河市"],
        ["新市区", "南市区", "北市区", "满城县", "清苑县", "涞水县", "阜平县", "徐水县", "定兴县", "唐县", "高阳县", "容城县", "涞源县", "望都县", "安新县", "易县", "曲阳县", "蠡县", "顺平县", "博野县", "雄县", "涿州市", "定州市", "安国市", "高碑店市"],
        ...
        ["安次区", "广阳区", "固安县", "永清县", "香河县", "大城县", "文安县", "大厂回族自治县", "霸州市", "三河市", "开发区"],
    ...
    [
        ["回民区", "玉泉区", "新城区", "赛罕区", "土默特左旗", "托克托县", "和林格尔县", "清水河县", "武川县"],
        ["东河区", "昆都仑区", "青山区", "石拐区", "白云矿区", "九原区", "土默特右旗", "固阳县", "达尔罕茂明安联合旗"],
        ["海勃湾区", "海南区", "乌达区"],
        ["红山区", "元宝山区", "松山区", "阿鲁科尔沁旗", "巴林左旗", "巴林右旗", "林西县", "克什克腾旗", "翁牛特旗", "喀喇沁旗", "宁城县", "敖汉旗", "新城区"],
    ...
    [
        ["和平区", "沈河区", "大东区", "皇姑区", "铁西区", "苏家屯区", "东陵区", "沈北新区", "于洪区", "辽中县", "康平县", "法库县", "新民市", "经济技术开发区", "浑南新区", "新城子经济技术开发区"],
        ["中山区", "西岗区", "沙河口区", "甘井子区", "旅顺口区", "金州区", "长海县", "瓦房店市", "普兰店市", "庄河市", "开发区", "保税区"],
        ...
        ["古塔区", "凌河区", "太和区", "黑山县", "义县", "凌海市", "北宁市", "松山新区", "经济技术开发区"],
    ...
    [
        ["南关区", "宽城区", "朝阳区", "二道区", "绿园区", "双阳区", "农安县", "九台市", "榆树市", "德惠市", "净月经济开发区", "高新技术产业开发区", "经济技术开发区"],
        ["昌邑区", "龙潭区", "船营区", "丰满区", "永吉县", "蛟河市", "桦甸市", "舒兰市", "磐石市"], ["铁西区", "铁东区", "梨树县", "伊通满族自治县", "公主岭市", "双辽市"],
        ["龙山区", "西安区", "东丰县", "东辽县"],
        ["东昌区", "二道江区", "通化县", "辉南县", "柳河县", "梅河口市", "集安市"],
        ["八道江区", "抚松县", "靖宇县", "长白朝鲜族自治县", "江源县", "临江市"],
        ["宁江区", "前郭尔罗斯蒙古族自治县", "长岭县", "乾安县", "扶余县"],
        ["洮北区", "镇赉县", "通榆县", "洮南市", "大安市"],
        ["延吉市", "图们市", "敦化市", "珲春市", "龙井市", "和龙市", "汪清县", "安图县"]
    ],
    [
        ["道里区", "南岗区", "道外区", "香坊区", "动力区", "平房区", "松北区", "呼兰区", "依兰县", "方正县", "宾县", "巴彦县", "木兰县", "通河县", "延寿县", "阿城市", "双城市", "尚志市", "五常市"],
        ...
        ["新兴区", "桃山区", "茄子河区", "勃利县"],
        ["东安区", "爱民区", "阳明区", "西安区", "东宁县", "林口县", "绥芬河市", "海林市", "宁安市", "穆棱市"],
    ...
    [
        ...
        ["崇安区", "南长区", "北塘区", "锡山区", "惠山区", "滨湖区", "江阴市", "宜兴市", "新区"],
        ["云龙区", "鼓楼区", "九里区", "泉山区", "铜山县", "贾汪区", "丰县", "沛县", "睢宁县", "新沂市", "邳州市"],
        ["天宁区", "钟楼区", "戚墅堰区", "新北区", "武进区", "溧阳市", "金坛市"],
        ["沧浪区", "平江区", "金阊区", "虎丘区", "吴中区", "相城区", "常熟市", "张家港市", "昆山市", "吴江市", "太仓市", "工业园区", "高新区"],
        ["崇川区", "港闸区", "海安县", "如东县", "启东市", "如皋市", "通州市", "海门市", "经济技术开发区"], ["连云区", "新浦区", "海州区", "赣榆县", "东海县", "灌云县", "灌南县"],
        ["清河区", "楚州区", "淮阴区", "清浦区", "涟水县", "洪泽县", "盱眙县", "金湖县"], ["亭湖区", "盐都区", "响水县", "滨海县", "阜宁县", "射阳县", "建湖县", "东台市", "大丰市"],
        ["广陵区", "邗江区", "宝应县", "仪征市", "高邮市", "江都市", "维扬区", "经济开发区"], ["京口区", "润州区", "丹徒区", "丹阳市", "扬中市", "句容市", "新区"],
        ["海陵区", "高港区", "兴化市", "靖江市", "泰兴市", "姜堰市"], ["宿城区", "宿豫区", "沭阳县", "泗阳县", "泗洪县"]
    ],
    [
        ...
        ["秀洲区", "嘉善县", "海盐县", "海宁市", "平湖市", "桐乡市", "南湖区"],
        ["吴兴区", "南浔区", "德清县", "长兴县", "安吉县"],
        ["越城区", "绍兴县", "新昌县", "诸暨市", "上虞市", "嵊州市"],
        ["婺城区", "金东区", "武义县", "浦江县", "磐安县", "兰溪市", "义乌市", "东阳市", "永康市"],
        ["柯城区", "衢江区", "常山县", "开化县", "龙游县", "江山市"],
        ["定海区", "普陀区", "岱山县", "嵊泗县"],
        ["椒江区", "路桥区", "黄岩区", "玉环县", "三门县", "天台县", "仙居县", "温岭市", "临海市"],
        ["莲都区", "青田县", "缙云县", "遂昌县", "松阳县", "云和县", "庆元县", "景宁畲族自治县", "龙泉市"]
    ],
    [
        ["瑶海区", "庐阳区", "蜀山区", "包河区", "长丰县", "肥东县", "肥西县", "经济技术开发区", "新站试验区", "政务文化新区", "高新技术产业开发区"],
        ["镜湖区", "鸠江区", "芜湖县", "繁昌县", "南陵县", "弋江区", "三山区"],
        ["龙子湖区", "蚌山区", "禹会区", "淮上区", "怀远县", "五河县", "固镇县"],
        ["大通区", "田家庵区", "谢家集区", "八公山区", "潘集区", "凤台县"],
        ["雨山区", "花山区", "金家庄区", "当涂县", "经济技术开发区"],
        ["杜集区", "相山区", "烈山区", "濉溪县"],
        ["铜官山区", "狮子山区", "郊区", "铜陵县"],
        ["迎江区", "大观区", "怀宁县", "枞阳县", "潜山县", "太湖县", "宿松县", "望江县", "岳西县", "桐城市", "宜秀区"],
        ["屯溪区", "黄山区", "徽州区", "歙县", "休宁县", "黟县", "祁门县"],
        ["琅琊区", "南谯区", "来安县", "全椒县", "定远县", "凤阳县", "天长市", "明光市"],
        ["颍州区", "颍东区", "颍泉区", "临泉县", "太和县", "阜南县", "颍上县", "界首市", "经济开发区"],
        ["埇桥区", "砀山县", "萧县", "灵璧县", "泗县"],
        ["居巢区", "庐江县", "无为县", "含山县", "和县"],
    ...
    [
        ...
        ["思明区", "海沧区", "湖里区", "集美区", "同安区", "翔安区", "鼓浪屿区", "象屿保税区", "火炬高新区"],
        ["城厢区", "涵江区", "荔城区", "秀屿区", "仙游县"],
        ["梅列区", "三元区", "明溪县", "清流县", "宁化县", "大田县", "尤溪县", "沙县", "将乐县", "泰宁县", "建宁县", "永安市"],
        ["鲤城区", "丰泽区", "洛江区", "泉港区", "惠安县", "安溪县", "永春县", "德化县", "金门县", "石狮市", "晋江市", "南安市", "经济技术开发区"],
    ...
    [
        ["东湖区", "西湖区", "青云谱区", "湾里区", "青山湖区", "南昌县", "新建县", "安义县", "进贤县", "经济技术开发区", "红谷滩新区", "高新技术产业开发区", "桑海经济技术开发区", "英雄经济开发区"],
        ["昌江区", "珠山区", "浮梁县", "乐平市"],
        ["安源区", "湘东区", "莲花县", "上栗县", "芦溪县"],
        ["庐山区", "浔阳区", "九江县", "武宁县", "修水县", "永修县", "德安县", "星子县", "都昌县", "湖口县", "彭泽县", "瑞昌市"],
        ["渝水区", "分宜县"],
        ["月湖区", "余江县", "贵溪市"],
        ["章贡区", "赣县", "信丰县", "大余县", "上犹县", "崇义县", "安远县", "龙南县", "定南县", "全南县", "宁都县", "于都县", "兴国县", "会昌县", "寻乌县", "石城县", "瑞金市", "南康市"],
    ...
    [
        ["历下区", "市中区", "槐荫区", "天桥区", "历城区", "长清区", "平阴县", "济阳县", "商河县", "章丘市", "高新区", "经济开发区"],
        ["市南区", "市北区", "四方区", "黄岛区", "崂山区", "李沧区", "城阳区", "胶州市", "即墨市", "平度市", "胶南市", "莱西市"],
        ["淄川区", "张店区", "博山区", "临淄区", "周村区", "桓台县", "高青县", "沂源县", "高新区"],
        ["市中区", "薛城区", "峄城区", "台儿庄区", "山亭区", "滕州市"],
        ["东营区", "河口区", "垦利县", "利津县", "广饶县"],
        ["芝罘区", "福山区", "牟平区", "莱山区", "长岛县", "龙口市", "莱阳市", "莱州市", "蓬莱市", "招远市", "栖霞市", "海阳市", "开发区"],
        ["潍城区", "寒亭区", "坊子区", "奎文区", "临朐县", "昌乐县", "青州市", "诸城市", "寿光市", "安丘市", "高密市", "昌邑市", "经济开发区", "滨海经济开发区", "高新技术开发区", "出口加工区"],
        ["市中区", "任城区", "微山县", "鱼台县", "金乡县", "嘉祥县", "汶上县", "泗水县", "梁山县", "曲阜市", "兖州市", "邹城市"],
        ["泰山区", "岱岳区", "宁阳县", "东平县", "新泰市", "肥城市"], ["环翠区", "文登市", "荣成市", "乳山市", "经济技术开发区", "高技术开发区"],
        ["东港区", "岚山区", "五莲县", "莒县"],
        ["莱城区", "钢城区"],
    ...
    [
        ["中原区", "二七区", "管城回族区", "金水区", "上街区", "中牟县", "巩义市", "荥阳市", "新密市", "新郑市", "登封市", "高新技术开发区", "惠济区", "经济技术开发区", "郑东新区", "出口加工区"],
        ["龙亭区", "顺河回族区", "鼓楼区", "杞县", "通许县", "尉氏县", "开封县", "兰考县", "金明区", "禹王台区"],
        ["老城区", "西工区", "瀍河回族区", "涧西区", "吉利区", "洛龙区", "孟津县", "新安县", "栾川县", "嵩县", "汝阳县", "宜阳县", "洛宁县", "伊川县", "偃师市", "高新技术开发区", "经济技术开发区"],
    ...
    [
        ...
        ["茅箭区", "张湾区", "郧县", "郧西县", "竹山县", "竹溪县", "房县", "丹江口市"],
        ["西陵区", "伍家岗区", "点军区", "虢亭区", "夷陵区", "远安县", "兴山县", "秭归县", "长阳土家族自治县", "五峰土家族自治县", "宜都市", "当阳市", "枝江市", "经济技术开发区"],
        ["襄城区", "樊城区", "襄阳区", "南漳县", "谷城县", "保康县", "老河口市", "枣阳市", "宜城市"],
        ["梁子湖区", "华容区", "鄂城区"],
        ["东宝区", "掇刀区", "京山县", "沙洋县", "钟祥市"],
    ...
    [
        ...
        ["雨湖区", "岳塘区", "湘潭县", "湘乡市", "韶山市"],
        ["珠晖区", "雁峰区", "石鼓区", "蒸湘区", "南岳区", "衡阳县", "衡南县", "衡山县", "衡东县", "祁东县", "耒阳市", "常宁市"],
        ["双清区", "大祥区", "北塔区", "邵东县", "新邵县", "邵阳县", "隆回县", "洞口县", "绥宁县", "新宁县", "城步苗族自治县", "武冈市"],
        ...
        ["冷水滩区", "祁阳县", "东安县", "双牌县", "道县", "江永县", "宁远县", "蓝山县", "新田县", "江华瑶族自治县", "零陵区"],
        ["鹤城区", "中方县", "沅陵县", "辰溪县", "溆浦县", "会同县", "麻阳苗族自治县", "新晃侗族自治县", "芷江侗族自治县", "靖州苗族侗族自治县", "通道侗族自治县", "洪江市"],
        ["娄星区", "双峰县", "新化县", "冷水江市", "涟源市"], ["吉首市", "泸溪县", "凤凰县", "花垣县", "保靖县", "古丈县", "永顺县", "龙山县"]
    ],
    [
        ["荔湾区", "越秀区", "海珠区", "天河区", "白云区", "黄埔区", "番禺区", "花都区", "增城市", "从化市", "南沙区", "萝岗区"],
        ["武江区", "浈江区", "曲江区", "始兴县", "仁化县", "翁源县", "乳源瑶族自治县", "新丰县", "乐昌市", "南雄市"],
        ["罗湖区", "福田区", "南山区", "宝安区", "龙岗区", "盐田区", "光明新区", "坪山新区"],
        ["香洲区", "斗门区", "金湾区"],
        ["龙湖区", "金平区", "濠江区", "潮阳区", "潮南区", "澄海区", "南澳县"],
        ["禅城区", "南海区", "顺德区", "三水区", "高明区"],
        ["蓬江区", "江海区", "新会区", "台山市", "开平市", "鹤山市", "恩平市"],
        ["赤坎区", "霞山区", "坡头区", "麻章区", "遂溪县", "徐闻县", "廉江市", "雷州市", "吴川市", "开发区"],
        ["茂南区", "茂港区", "电白县", "高州市", "化州市", "信宜市"],
        ["端州区", "鼎湖区", "广宁县", "怀集县", "封开县", "德庆县", "高要市", "四会市", "高新技术产业开发区"],
        ...
        ["南城区", "石龙镇", "长安镇", "虎门镇", "横沥镇", "寮步镇", "黄江镇", "清溪镇", "莞城区", "万江区", "东城区", "石碣镇", "茶山镇", "石排镇", "企石镇", "桥头镇", "谢岗镇", "东坑镇", "常平镇", "大朗镇", "塘厦镇", "凤岗镇", "厚街镇", "沙田镇", "道滘镇", "洪梅镇", "麻涌镇", "中堂镇", "高埗镇", "樟木头镇", "大岭山镇", "望牛墩镇"],
        ["中山市"],
        ["湘桥区", "潮安县", "饶平县"],
        ["榕城区", "揭东县", "揭西县", "惠来县", "普宁市", "东山区", "普侨区", "大南山侨区"],
        ["云城区", "新兴县", "郁南县", "云安县", "罗定市"]
    ],
    [
        ["兴宁区", "青秀区", "江南区", "西乡塘区", "良庆区", "邕宁区", "武鸣县", "隆安县", "马山县", "上林县", "宾阳县", "横县"],
        ["城中区", "鱼峰区", "柳南区", "柳北区", "柳江县", "柳城县", "鹿寨县", "融安县", "融水苗族自治县", "三江侗族自治县"],
        ["秀峰区", "叠彩区", "象山区", "七星区", "雁山区", "阳朔县", "临桂县", "灵川县", "全州县", "兴安县", "永福县", "灌阳县", "龙胜各族自治县", "资源县", "平乐县", "荔浦县", "恭城瑶族自治县"],
        ["万秀区", "蝶山区", "长洲区", "苍梧县", "藤县", "蒙山县", "岑溪市"],
        ["海城区", "银海区", "铁山港区", "合浦县"],
        ["港口区", "防城区", "上思县", "东兴市"],
        ["钦南区", "钦北区", "灵山县", "浦北县", "钦州港经济开发区"],
        ["港北区", "港南区", "覃塘区", "平南县", "桂平市"],
        ...
        ["兴宾区", "忻城县", "象州县", "武宣县", "金秀瑶族自治县", "合山市"], ["江洲区", "扶绥县", "宁明县", "龙州县", "大新县", "天等县", "凭祥市"]
    ],
    [
        ["秀英区", "龙华区", "琼山区", "美兰区"],
        ["河西区", "河东区", "田独镇", "凤凰镇", "三亚市", "崖城镇", "天涯镇", "育才乡", "海棠湾镇"],
        ["五指山市", "琼海市", "儋州市", "文昌市", "万宁市", "东方市", "定安县", "屯昌县", "澄迈县", "临高县", "白沙黎族自治县", "昌江黎族自治县", "乐东黎族自治县", "陵水黎族自治县", "保亭黎族苗族自治县", "琼中黎族苗族自治县", "西、南、中沙群岛办事处"]
    ],
    [
        ["万州区", "涪陵区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "万盛区", "双桥区", "渝北区", "巴南区", "黔江区", "长寿区", "綦江县", "潼南县", "铜梁县", "大足县", "荣昌县", "璧山县", "梁平县", "城口县", "丰都县", "垫江县", "武隆县", "忠县", "开县", "云阳县", "奉节县", "巫山县", "巫溪县", "石柱土家族自治县", "秀山土家族苗族自治县", "酉阳土家族苗族自治县", "彭水苗族土家族自治县", "高新区", "江津区", "合川区", "永川区", "南川区"]
    ],
    [
        ["锦江区", "青羊区", "金牛区", "武侯区", "成华区", "龙泉驿区", "青白江区", "新都区", "温江区", "金堂县", "双流县", "郫县", "大邑县", "蒲江县", "新津县", "都江堰市", "彭州市", "邛崃市", "崇州市", "高新区", "高新西区"],
        ["自流井区", "贡井区", "大安区", "沿滩区", "荣县", "富顺县"],
        ["东区", "西区", "仁和区", "米易县", "盐边县"],
        ["江阳区", "纳溪区", "龙马潭区", "泸县", "合江县", "叙永县", "古蔺县"],
        ["旌阳区", "中江县", "罗江县", "广汉市", "什邡市", "绵竹市"],
        ["涪城区", "游仙区", "三台县", "盐亭县", "安县", "梓潼县", "北川羌族自治县", "平武县", "江油市", "农科区", "经济技术开发区", "高新区", "仙海区"],
        ["利州区", "元坝区", "朝天区", "旺苍县", "青川县", "剑阁县", "苍溪县"], ["船山区", "安居区", "蓬溪县", "射洪县", "大英县"],
        ["市中区", "东兴区", "威远县", "资中县", "隆昌县"],
    ...
    [
        ["南明区", "云岩区", "花溪区", "乌当区", "白云区", "小河区", "开阳县", "息烽县", "修文县", "清镇市", "金阳新区"],
        ["钟山区", "六枝特区", "水城县", "盘县"],
    ...
    [
        ["五华区", "盘龙区", "官渡区", "西山区", "东川区", "呈贡县", "晋宁县", "富民县", "宜良县", "石林彝族自治县", "嵩明县", "禄劝彝族苗族自治县", "寻甸回族彝族自治县", "安宁市"],
        ["麒麟区", "马龙县", "陆良县", "师宗县", "罗平县", "富源县", "会泽县", "沾益县", "宣威市"],
        ...
        ["个旧市", "开远市", "蒙自县", "屏边苗族自治县", "建水县", "石屏县", "弥勒县", "泸西县", "元阳县", "红河县", "金平苗族瑶族傣族自治县", "绿春县", "河口瑶族自治县"],
    ...
    [
        ...
        ["那曲县", "嘉黎县", "比如县", "聂荣县", "安多县", "申扎县", "索县", "班戈县", "巴青县", "尼玛县"],
        ["普兰县", "札达县", "噶尔县", "日土县", "革吉县", "改则县", "措勤县"],
        ["林芝县", "工布江达县", "米林县", "墨脱县", "波密县", "察隅县", "朗县"]
    ],
    [
        ["新城区", "碑林区", "莲湖区", "灞桥区", "未央区", "雁塔区", "阎良区", "临潼区", "长安区", "蓝田县", "周至县", "户县", "高陵县", "高新区"],
        ["王益区", "印台区", "耀州区", "宜君县", "新区"],
        ["渭滨区", "金台区", "陈仓区", "凤翔县", "岐山县", "扶风县", "眉县", "陇县", "千阳县", "麟游县", "凤县", "太白县"],
        ["秦都区", "渭城区", "杨陵区", "三原县", "泾阳县", "兴平市", "乾县", "礼泉县", "永寿县", "彬县", "长武县", "旬邑县", "淳化县", "武功县"],
        ["临渭区", "华县", "潼关县", "大荔县", "合阳县", "澄城县", "蒲城县", "白水县", "富平县", "韩城市", "华阴市"],
        ["宝塔区", "延长县", "延川县", "子长县", "安塞县", "志丹县", "吴旗县", "甘泉县", "富县", "洛川县", "宜川县", "黄龙县", "黄陵县"],
        ["汉台区", "南郑县", "城固县", "洋县", "西乡县", "勉县", "宁强县", "略阳县", "镇巴县", "留坝县", "佛坪县", "经济开发区"],
    ...
    [
        ...
        ["肃州区", "金塔县", "安西县", "肃北蒙古族自治县", "阿克塞哈萨克族自治县", "玉门市", "敦煌市"],
    ...
    [
        ["城东区", "城中区", "城西区", "城北区", "大通回族土族自治县", "湟中县", "湟源县"],
        ["平安县", "民和回族土族自治县", "乐都县", "互助土族自治县", "化隆回族自治县", "循化撒拉族自治县"],
        ["门源回族自治县", "祁连县", "海晏县", "刚察县"],
        ["同仁县", "尖扎县", "泽库县", "河南蒙古族自治县"],
        ["共和县", "同德县", "贵德县", "兴海县", "贵南县"],
        ["玛沁县", "班玛县", "甘德县", "达日县", "久治县", "玛多县"],
        ["玉树县", "杂多县", "称多县", "治多县", "囊谦县", "曲麻莱县"],
        ["格尔木市", "德令哈市", "乌兰县", "都兰县", "天峻县", "大柴旦行委"]
    ],
    [
    ...
    [
        ...
        ["吐鲁番市", "鄯善县", "托克逊县"],
        ["哈密市", "巴里坤哈萨克自治县", "伊吾县"],
        ["昌吉市", "阜康市", "米泉市", "呼图壁县", "玛纳斯县", "奇台县", "吉木萨尔县", "木垒哈萨克自治县"],
        ["博乐市", "精河县", "温泉县"],
...
function renderCitySelect(obj_1, obj_2, obj_3, val_1, val_2, val_3) {
    //定义默认数据
    ...
    for (var i = 0; i < province.length; i++) {
        if (province[i] == val_1) {
            pindex = i;
            $("<option selected>" + province[i] + "</option>").appendTo($("#" + obj_1));
        } else {
            $("<option>" + province[i] + "</option>").appendTo($("#" + obj_1));
        }
    }

    if (pindex != 0) {
        for (var n = 1; n < city[pindex].length + 1; n++) {
            if (city[pindex][n - 1] == val_2) {
                cindex = n;
                $("<option selected>" + city[pindex][n - 1] + "</option>").appendTo($("#" + obj_2));
            } else {
                $("<option>" + city[pindex][n - 1] + "</option>").appendTo($("#" + obj_2));
            }
        }
    }

    if (cindex != 0) {
        for (var m = 0; m < district[pindex][cindex - 1].length; m++) {
            if (district[pindex][cindex - 1][m] == val_3) {
                $("<option selected>" + district[pindex][cindex - 1][m] + "</option>").appendTo($("#" + obj_3));
            } else {
                $("<option>" + district[pindex][cindex - 1][m] + "</option>").appendTo($("#" + obj_3));
            }
        }
    }
    ...
    $("#" + obj_1).change(function () {
        ...
        if (pindex != 0) {
            for (k = 0; k < city[pindex - 1].length; k++) {
                $("<option>" + city[pindex - 1][k] + "</option>").appendTo($("#" + obj_2));
            }
        }
        //清空h
        $("#" + obj_3).empty();
    ...
    $("#" + obj_2).change(function () {
        ...
        $("<option>" + ar[2] + "</option>").appendTo($("#" + obj_3));
        if (cindex != 0) {
            for (j = 0; j < district[pindex - 1][cindex - 1].length; j++) {
                $("<option>" + district[pindex - 1][cindex - 1][j] + "</option>").appendTo($("#" + obj_3));
            }
        }
    });
}
